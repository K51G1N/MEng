...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="Synthetic Verification FEPSO")
    parser.add_argument("--k", type=int, default=6, help="Active cameras to select (K)")
    ...
    # 2. Instantiate and Run Optimizer repeatedly
    for exp in range(args.repeat_experiments):
        print(f"\n--- Running Experiment {exp + 1}/{args.repeat_experiments} ---")
