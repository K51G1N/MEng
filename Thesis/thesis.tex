...
% Name 
\title{Improving markerless pose estimation by optimising camera placement}
\author{Keagan Justin Ellenberger}{Keagan Justin Ellenberger}
\newcommand{\Studentnumber}{12345678}
\faculty{Faculty of Engineering}
\degree{MEng (Electronic Engineering)}{Masters of Engineering (Electronic Engineering)}
\supervisor[c]{Prof.\ Rensu P. Theart}
...
\input{chapters/my_introduction.tex}
\input{chapters/my_literature.tex}
\input{chapters/my_chapter3.tex}
\input{chapters/my_chapter4.tex}
\input{chapters/my_chapter5.tex}
\input{chapters/my_chapter6.tex}

% \input{chapters/my_methodology.tex}
% \input{chapters/pr_introduction.tex}
% \input{chapters/pr_chapter1.tex}
% \input{chapters/pr_literature.tex}
